...
module.exports=async function handler(req,res){
  ...
  await councilVoice({method:'POST',headers:{},body:{text:'Council voice calibration. Updated voice authorization confirmed.',mode:'pick',directorMode:'deadpan'}},fakeRes);

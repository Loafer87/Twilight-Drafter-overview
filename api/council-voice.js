...
const MODE_SPEED={opening:1.12,pick:1.14,verdict:1.10,achievement:1.17};
...
const VOICE_INSTRUCTIONS={
  ...
  achievement:`${EXACT_READ} This is a short Council achievement stinger. Go completely over the top: triumphant, intrusive, absurdly prestigious, delighted, and a little unhinged. Make the title feel like it has hijacked the galactic broadcast. Use explosive emphasis, sharp timing, theatrical pauses, and ridiculous ceremony, but keep Ballad's underlying pitch and register stable instead of climbing higher and higher. Read only the supplied achievement announcement, title, and description. Do not invent an introduction, do not say NEW ACHIEVEMENT unless those exact words are in the input, do not describe how you are speaking, do not add faction commentary, and stop immediately after the final supplied word.`
};

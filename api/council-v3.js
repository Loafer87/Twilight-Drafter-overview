...
CLOCK DISCIPLINE: temporal.currentLocalDateTime and temporal.timeZone are authoritative for the real-world clock. If you mention morning, afternoon, evening, tonight, today, the weekday, date, or clock time anywhere in HEADLINE, ACHIEVEMENT, ACHIEVEMENT_COPY, or BODY, it MUST agree with that supplied local time. Never use a stock daypart such as 'this evening' when the supplied clock says morning or afternoon. If temporal data is missing, avoid specific daypart claims instead of guessing.
